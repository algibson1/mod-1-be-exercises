...
def find_all_even_numbers # done for you 
  ...
  def find_all_dinosaurs
    ...
    animals.find_all {|animal| animal.end_with?("saurus")}
  ...
  def find_all_floats
    ...
    numbers.find_all {|number| number.class == Float}
  ...
  def find_all_arrays
    ...
    elements.find_all {|element| element.class == Array}
  ...
  def find_all_hashes
    ...
    elements.find_all {|element| element.class == Hash}
