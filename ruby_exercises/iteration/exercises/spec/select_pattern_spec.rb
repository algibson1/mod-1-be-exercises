RSpec.describe 'select pattern' do
  ...
  it 'test 5' do
    ...
    furniture.each do |thing|
      words_with_c << thing if thing.include?("c")
    end
  ...
  it 'test 6' do
    ...
    words_with_c = {}
    furniture.each do |location, thing|
      words_with_c[location] = thing if thing.include?("c")
    end
  ...
  it 'test 8' do
    ...
    meal.each do |course, food|
      two_words[course] = food if food.count(" ") == 1
    end
