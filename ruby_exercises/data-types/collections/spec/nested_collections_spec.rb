RSpec.describe 'Nested Collections' do
  ...
  it 'test 2' do
    ...
    # thirty_nine = coordinates.flatten.at(5)
    thirty_nine = coordinates.at(2).at(1)
  ...
  it 'test 4' do
    ...
    # to 0
    # coordinates.last.pop
    # coordinates.last.push(0)
  ...
  it 'test 15' do
    ...
    actual = three_day_forecast.values.first.at(1).values.first
    expected = 55
    expect(actual).to eq(expected)
  end
  ...
  it 'test 16' do
    ...
    actual = three_day_forecast.values.first.first.keys
  ...
  it 'test 17' do
    ...
    actual = three_day_forecast.values.first.last.values
