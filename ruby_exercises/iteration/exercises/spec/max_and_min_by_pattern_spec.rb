RSpec.describe 'max and min by pattern' do
  ...
  it 'test 9' do
    ...
    programmers.each do |program|
      fewest_programmers = program if program.length < fewest_programmers.length
    end
  ...
  it 'test 10' do
    ...
    programmers.each do |program, members|
      fewest_programmers = program if members.length < programmers[fewest_programmers].length
    end
